...
def run(test_config=None):
    ...
    # 保存结果
    save_result("crates_enhanced", {
        "api_name": "Crates.io (Enhanced with Metadata Filtering)",
    ...
    print(f"\n{'='*70}")
    print(f"✓ Crates.io增强测试完成!")
    print(f"{'='*70}")
    print(f"\n结果已保存: output/api_tests/crates_enhanced.json")
